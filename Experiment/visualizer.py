...
def visualize(X, y, X_resampled, y_resampled):
    ...
    c0 = ax1.scatter(X_vis[y == '0', 0], X_vis[y == '0', 1], label="Class #0", alpha=0.5, marker='.')
    c1 = ax1.scatter(X_vis[y == '1', 0], X_vis[y == '1', 1], label="Class #1", alpha=0.5, marker='.')
    ...
    ax2.set_title('After EG-SMOTE ReSampling')
    ...
    f.legend((c0, c1), ('Class #0', 'Class #1'), loc='lower center', ncol=2, labelspacing=0.5)
